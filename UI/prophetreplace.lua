...
--=================================================================================================================
function GlobalizationDummyBuilding(playerID)
...
GameEvents.TeamSetHasTech.Add(GlobalizationDummyBuilding)
GameEvents.PlayerCityFounded.Add(GlobalizationDummyBuilding)
GameEvents.CityCaptureComplete.Add(GlobalizationDummyBuilding)
-------------------------------------------------------------------------------------------------------------------------
